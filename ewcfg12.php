...
define("EW_PROJECT_NAME", "tmnstudio_order", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{5641CEBD-AA62-4C55-9718-A8075144C930}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'XafrE9OaO5xPlDqO', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/tmnstudio_order.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "order", "qs" => "`", "qe" => "`");
...
// Security
define("EW_ADMIN_USER_NAME", "tokotekn", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "6m676Oyy", TRUE); // Administrator password
...
// Email
define("EW_SMTP_SERVER", "mail.tokoteknologi.co.id", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 25, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "", TRUE);
define("EW_SMTP_SERVER_USERNAME", "order@tokoteknologi.co.id", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "order", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "order@tokoteknologi.co.id", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "order@tokoteknologi.co.id", TRUE); // Recipient email address
...
define("EW_UPLOAD_DEST_PATH", "/file/", TRUE); // Upload destination path (relative to app root)
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "jpg,jpeg,png,pdf,zip,rar,brd,sch", TRUE); // Allowed file extensions
