...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'desain'))
		$this->Page_Terminate("desainlist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'user'))
			$this->Page_Terminate("userlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'status_order'))
			$this->Page_Terminate("status_orderlist.php");
