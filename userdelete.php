...
<?php if ($user->NamaLengkap->Visible) { // NamaLengkap ?>
		<th><span id="elh_user_NamaLengkap" class="user_NamaLengkap"><?php echo $user->NamaLengkap->FldCaption() ?></span></th>
<?php } ?>
<?php if ($user->NomorHP->Visible) { // NomorHP ?>
		<th><span id="elh_user_NomorHP" class="user_NomorHP"><?php echo $user->NomorHP->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($user->NamaLengkap->Visible) { // NamaLengkap ?>
		<td<?php echo $user->NamaLengkap->CellAttributes() ?>>
<span id="el<?php echo $user_delete->RowCnt ?>_user_NamaLengkap" class="user_NamaLengkap">
...
<?php } ?>
<?php if ($user->NomorHP->Visible) { // NomorHP ?>
		<td<?php echo $user->NomorHP->CellAttributes() ?>>
<span id="el<?php echo $user_delete->RowCnt ?>_user_NomorHP" class="user_NomorHP">
