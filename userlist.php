...
class cuser_list extends cuser {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->NamaLengkap->AdvancedSearch->ToJSON(), ","); // Field NamaLengkap
		$sFilterList = ew_Concat($sFilterList, $this->NomorHP->AdvancedSearch->ToJSON(), ","); // Field NomorHP
	...
	function RestoreFilterList() {
		...
		// Field NamaLengkap
		$this->NamaLengkap->AdvancedSearch->SearchValue = @$filter["x_NamaLengkap"];
		$this->NamaLengkap->AdvancedSearch->SearchOperator = @$filter["z_NamaLengkap"];
		$this->NamaLengkap->AdvancedSearch->SearchCondition = @$filter["v_NamaLengkap"];
		$this->NamaLengkap->AdvancedSearch->SearchValue2 = @$filter["y_NamaLengkap"];
		$this->NamaLengkap->AdvancedSearch->SearchOperator2 = @$filter["w_NamaLengkap"];
		$this->NamaLengkap->AdvancedSearch->Save();

		// Field NomorHP
		$this->NomorHP->AdvancedSearch->SearchValue = @$filter["x_NomorHP"];
		$this->NomorHP->AdvancedSearch->SearchOperator = @$filter["z_NomorHP"];
		$this->NomorHP->AdvancedSearch->SearchCondition = @$filter["v_NomorHP"];
		$this->NomorHP->AdvancedSearch->SearchValue2 = @$filter["y_NomorHP"];
		$this->NomorHP->AdvancedSearch->SearchOperator2 = @$filter["w_NomorHP"];
		$this->NomorHP->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->NomorHP, $arKeywords, $type);
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->NamaLengkap); // NamaLengkap
			$this->UpdateSort($this->NomorHP); // NomorHP
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->NamaLengkap->setSort("");
				$this->NomorHP->setSort("");
				$this->_Email->setSort("");
			}
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.fuserlist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->CanDelete());
...
<?php if ($user->_UserID->Visible) { // UserID ?>
	<?php if ($user->SortUrl($user->_UserID) == "") { ?>
		<th data-name="_UserID"><div id="elh_user__UserID" class="user__UserID"><div class="ewTableHeaderCaption"><?php echo $user->_UserID->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_UserID"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->_UserID) ?>',1);"><div id="elh_user__UserID" class="user__UserID">
...
<?php if ($user->NamaLengkap->Visible) { // NamaLengkap ?>
	<?php if ($user->SortUrl($user->NamaLengkap) == "") { ?>
		<th data-name="NamaLengkap"><div id="elh_user_NamaLengkap" class="user_NamaLengkap"><div class="ewTableHeaderCaption"><?php echo $user->NamaLengkap->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="NamaLengkap"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->NamaLengkap) ?>',1);"><div id="elh_user_NamaLengkap" class="user_NamaLengkap">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->NamaLengkap->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->NamaLengkap->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->NamaLengkap->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->NomorHP->Visible) { // NomorHP ?>
	<?php if ($user->SortUrl($user->NomorHP) == "") { ?>
		<th data-name="NomorHP"><div id="elh_user_NomorHP" class="user_NomorHP"><div class="ewTableHeaderCaption"><?php echo $user->NomorHP->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="NomorHP"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->NomorHP) ?>',1);"><div id="elh_user_NomorHP" class="user_NomorHP">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->NomorHP->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->NomorHP->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->NomorHP->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->_Email->Visible) { // Email ?>
	<?php if ($user->SortUrl($user->_Email) == "") { ?>
		<th data-name="_Email"><div id="elh_user__Email" class="user__Email"><div class="ewTableHeaderCaption"><?php echo $user->_Email->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_Email"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->_Email) ?>',1);"><div id="elh_user__Email" class="user__Email">
...
<span id="el<?php echo $user_list->RowCnt ?>_user_NamaLengkap" class="user_NamaLengkap">
<span<?php echo $user->NamaLengkap->ViewAttributes() ?>>
<?php echo $user->NamaLengkap->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($user->NomorHP->Visible) { // NomorHP ?>
		<td data-name="NomorHP"<?php echo $user->NomorHP->CellAttributes() ?>>
<span id="el<?php echo $user_list->RowCnt ?>_user_NomorHP" class="user_NomorHP">
<span<?php echo $user->NomorHP->ViewAttributes() ?>>
<?php echo $user->NomorHP->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($user->_Email->Visible) { // Email ?>
