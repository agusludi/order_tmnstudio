...
class cuser_view extends cuser {
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_user\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_user',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fuserview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
<?php if ($user->NamaLengkap->Visible) { // NamaLengkap ?>
	<tr id="r_NamaLengkap">
		<td><span id="elh_user_NamaLengkap"><?php echo $user->NamaLengkap->FldCaption() ?></span></td>
		<td data-name="NamaLengkap"<?php echo $user->NamaLengkap->CellAttributes() ?>>
<span id="el_user_NamaLengkap">
<span<?php echo $user->NamaLengkap->ViewAttributes() ?>>
<?php echo $user->NamaLengkap->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user->NomorHP->Visible) { // NomorHP ?>
	<tr id="r_NomorHP">
		<td><span id="elh_user_NomorHP"><?php echo $user->NomorHP->FldCaption() ?></span></td>
		<td data-name="NomorHP"<?php echo $user->NomorHP->CellAttributes() ?>>
<span id="el_user_NomorHP">
<span<?php echo $user->NomorHP->ViewAttributes() ?>>
<?php echo $user->NomorHP->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user->Alamat->Visible) { // Alamat ?>
	<tr id="r_Alamat">
		<td><span id="elh_user_Alamat"><?php echo $user->Alamat->FldCaption() ?></span></td>
		<td data-name="Alamat"<?php echo $user->Alamat->CellAttributes() ?>>
<span id="el_user_Alamat">
<span<?php echo $user->Alamat->ViewAttributes() ?>>
<?php echo $user->Alamat->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
